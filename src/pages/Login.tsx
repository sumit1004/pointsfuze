    ...
    <div className="min-h-screen bg-gray-950 flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-gray-900/80 backdrop-blur-md p-8 rounded-2xl border border-white/10 shadow-2xl z-10 relative">
        <div className="flex flex-col items-center justify-center mb-8">
          ...
          <p className="text-gray-400 mt-2">Login to manage your tournaments</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <button 
            type="submit" 
            disabled={loading}
            className="w-full bg-gradient-to-r from-purple-600 to-cyan-500 hover:from-purple-500 hover:to-cyan-400 text-white font-bold py-3 rounded-lg mt-4 transition-all"
          >
