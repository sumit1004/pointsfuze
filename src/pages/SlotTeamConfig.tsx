...
const SlotTeamConfig: React.FC = () => {
  const navigate = useNavigate();
  
  // Initialize state from localStorage if available
  const [config, setConfig] = useState<GameConfig>(() => {
    const savedConfig = localStorage.getItem('slotTeamGameConfig');
  ...
  useEffect(() => {
    localStorage.setItem('slotTeamGameConfig', JSON.stringify({
      ...config,
  ...
  return (
    <ConfigLayout title="Global Points Configuration - Slot & Team">
